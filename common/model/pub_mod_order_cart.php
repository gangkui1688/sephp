...
class pub_mod_order_cart extends pub_mod_model
{
    public static
        ...
        $_pk     = 'cart_id',
        $_fields = [
            'cart_id'     => ['type' => 'int',  'required' => true, 'comment' => '品牌ID'],
            'goods_id'    => ['type' => 'text', 'required' => true, 'comment' => '商品ID'],
            'number'      => ['type' => 'text', 'required' => true, 'comment' => '商品数量'],
            'params'      => ['type' => 'text', 'required' => true, 'comment' => '购物车对象参数'],
            'params'      => ['type' => 'text', 'required' => true, 'comment' => '购物车对象参数'],
            'params'      => ['type' => 'text', 'required' => true, 'comment' => '购物车对象参数'],
            'params'      => ['type' => 'text', 'required' => true, 'comment' => '购物车对象参数'],
            'params'      => ['type' => 'text', 'required' => true, 'comment' => '购物车对象参数'],
            'ip'          => ['type' => 'text', 'default' => null, 'comment' => 'ip地址'],
