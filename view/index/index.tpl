...
<link rel="stylesheet" type="text/css" href="static/style/css/basic.css"/>
<link rel="stylesheet" type="text/css" href="static/style/css/index.css"/>
<script type="text/javascript" src="static/style/js/jquery-1.8.1.min.js"></script>
<script type="text/javascript" src="static/style/js/jquery.cycle.all.js"></script>
...
<header>
  <div class="header">
    <div class="top">
      <div class="top_con">
      <span class="mail">
      <img alt="咨询邮箱" src="static/style/images/mail.png" align="Baseline" /> 咨询邮箱：<span>service@yitianxinda.com</span></span>
      <span class="tel"><img alt="咨询热线" src="static/style/images/tel.png" align="Baseline" /> 咨询热线：<span>400-668-3065</span></span>
       <span><a href="#" rel="noFollow" target="_blank"><img alt="微博" src="static/style/images/xinlang.png" align="Baseline" /></a></span>
       <span><img alt="微信" src="static/style/images/weixin.png" align="Baseline" /></span> </div>
    </div>
    <div class="head_bg">
      <div class="head">
        <div class="logo fl"><h1><a href="#"><img alt="" src="static/style/images/logo.png" /></a></h1></div>
        <div class="menu fr">
          <nav>
            <ul>
...
<a href='service/index.html'>软件系统外包</a> </dd>
        ...
        <dl class="footer_dl2" style="width:340px;">
          <dt>联系我们</dt>
          <dd><img src="static/style/images/xinlang.png" alt="官方微博"  /><a href="#" rel="noFollow" target="_blank">官方微博: </a></dd>
          <dd><img src="static/style/images/mail.png" alt="软件开发咨询邮箱" /><a href="mailto:service@yitianxinda.com">咨询邮箱：service@yitianxinda.com</a></dd>
          <dd><img src="static/style/images/tel.png" alt="北京软件开发免费咨询电话" />咨询热线：400-668-3065</dd>
          <dd><img src="static/style/images/weixin.png" alt="软件开发公司" />微信：</dd>
        </dl>
...
<input type="hidden" name="do" value="2" />
        ...
        <dl class="footer_dl3">
          ...
          <dd><input type="image" alt="提交留言"  src="static/style/images/submit_button.png"/></dd>
        </dl>
