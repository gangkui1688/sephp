...
<form class="layui-form" style="width:80%;" method="post" action="<{$add_save_url}>">
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input userPassword" lay-verify="" placeholder="请输入登录密码" />
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs12">
        <label class="layui-form-label">邮箱</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input userEmail" lay-verify="" placeholder="请输入邮箱" />
        </div>
    </div>
    <div class="layui-row">
        ...
        <div class="magb15 layui-col-md4 layui-col-xs12">
            <label class="layui-form-label">权 限 组</label>
            <div class="layui-input-block">
...
<script type="text/javascript" src="static/iframe/js/add.js"></script>
</body>
</html>