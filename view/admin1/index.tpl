...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav mobileTopLevelMenus" mobile>
                <li class="layui-nav-item" data-menu="contentManagement">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <{/foreach}>
                        <!--dd class="layui-this" data-menu="memberCenter"><a href="javascript:;"><i class="seraph icon-icon10" data-icon="icon-icon10"></i><cite>用户中心</cite></a></dd>
            ...
            <ul class="layui-nav topLevelMenus" pc>
                <{foreach from=$top_menus key="id_name" item="menu"}>
                <li class="layui-nav-item" data-menu="<{$id_name}>" >
                    <a href="javascript:;"><i class="<{$menu.icon}>"></i><cite><{$menu.title}></cite></a>
                </li>
                <{/foreach}>
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="static/iframe/images/face.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">驊驊龔頾</cite></a>
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="?ct=public&ac=logout" class="signOut"><i class="seraph icon-tuichu"></i><cite>退出</cite></a></dd>
                    </dl>
                </li>
            </ul>
        </div>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像" ><img src="static/iframe/images/face.jpg" class="userAvatar"></a>
        ...
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="?ct=index&ac=main"><i class="layui-icon" data-icon=""></i><cite>后台首页</cite></a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show">
                    <iframe src="?ct=index&ac=main"></iframe>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="static/iframe/js/index.js"></script>
