...
<div class="middle-box text-center loginscreen  animated fadeInDown">
    <div>
        ...
        <form class="m-t" method="post" target="_self"  role="form" action="<{$_self_url}>">
            <input name="username" type="hidden" value="<{$_forms.username}>" />
            <input name="password" type="hidden" value="<{$_forms.password}>" />

            <div class="form-group">
                <input type="text" name="code" class="form-control" placeholder="google验证码" required="" />
            </div>
