...
# Database: sephp
# Generation Time: 2019-10-14 10:59:55 +0000
# ************************************************************
...
VALUES
	(1,1,'admin','$2y$10$tra3DMOjyKhDpQD1qe82Oe6b3n7StDIkprH8UXtscUdYo46DnAsim',1,'admin@admin.com',1,'钢盔','so fuck beautiful',NULL,'EEOQBNTJ7CDGCWPDVSVVQGZ37FK7RBU7','brplbb6pub9ck2iiqndkv2dt4t'),
...
CREATE TABLE `se_goods` (
  ...
  `goods_sn` varchar(200) DEFAULT NULL COMMENT '商品编号',
...
CREATE TABLE `se_goods_brand` (
  ...
  `addusesr` char(1) NOT NULL DEFAULT '' COMMENT '32',
  `addtime` int(11) NOT NULL,
  `upuser` char(1) DEFAULT '0' COMMENT '32',
