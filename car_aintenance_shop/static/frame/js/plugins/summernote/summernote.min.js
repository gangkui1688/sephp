!function(a) {
    ...
    var c = {
        ...
        this.stylePara = function(b, c) {
            ...
            this.current = function(c, d) {
                var e = a(f.isText(c.sc) ? c.sc.parentNode : c.sc)
                    ...
                    , h = b(e, g) || {};
                if (h["font-size"] = parseInt(h["font-size"], 10),
                        h["font-bold"] = document.queryCommandState("bold") ? "bold" : "normal",
                        h["font-italic"] = document.queryCommandState("italic") ? "italic" : "normal",
                        h["font-underline"] = document.queryCommandState("underline") ? "underline" : "normal",
                        h["font-strikethrough"] = document.queryCommandState("strikeThrough") ? "strikethrough" : "normal",
                        c.isOnList()) {
        ...
        var b = !!document.createRange
            ...
            for (c = 0; c < i.length; c++)
                if (!f.isText(i[c])) {
                    if (h.moveToElementText(i[c]),
                        h.compareEndPoints("StartToStart", a) >= 0)
                        break;
                    d = i[c]
                }
            if (0 !== c && f.isText(i[c - 1])) {
                ...
                b && k.nextSibling && f.isText(k.nextSibling) && m === k.nodeValue.length && (m -= k.nodeValue.length,
                    k = k.nextSibling),
                    g = k,
                    c = m
            }
        ...
        this.tab = function(a, b) {
            ...
            this.insertVideo = function(b, c) {
                ...
                d && (d.attr("frameborder", 0),
                    k.create().insertNode(d[0]))
            }
            ,
        ...
        this.fontSize = function(a, b) {
            ...
            this.createLink = function(b, d, g) {
                ...
                e(b);
                var i = d;
                if (-1 !== d.indexOf("@") && -1 === d.indexOf(":") ? i = "mailto:" + d : -1 === d.indexOf("://") && (i = "http://" + d),
                    (c.bMSIE || c.bFF) && h.isCollapsed()) {
        ...
        this.undo = function(e) {
            var f = c(e);
            0 !== a.length && (d(e, a.pop()),
                b.push(f))
        }
            ,
            this.redo = function(e) {
                var f = c(e);
                0 !== b.length && (d(e, b.pop()),
                    a.push(f))
            }
            ,
        ...
        var d = new m
            ...
            c && (g.update(b.toolbar(), c),
                j.update(b.popover(), c),
                k.update(b.handle(), c))
        }
            , w = function(a) {
            var b = s(a.currentTarget || a.target);
            ...
            if (h.length > 0) {
                ...
                if (d[m] && (u.trigger("focus"),
                        d[m](u, n, k)),
                    -1 !== a.inArray(m, ["backColor", "foreColor"]))
                    ...
                    u.focus(),
                        l.showImageDialog(u, r).then(function(a) {
                            "string" == typeof a ? (d.restoreRange(u),
                                d.insertImage(u, a)) : t(u, a)
                        });
                    ...
                    E ? (u.data("orgHeight", u.css("height")),
                        ...
                        C.css("overflow", "hidden")) : (a(window).off("resize"),
                        D({
                            w: x.width || "",
                            h: u.data("orgHeight")
                        }),
                    ...
                    if (F) {
                        if (w.val(u.html()),
                            ...
                            G && (i = new b.TernServer(G),
                                j.ternServer = i,
                                j.on("cursorActivity", function(a) {
                                    i.updateArgHints(a)
                                })),
                        ...
                        c.bCodeMirror && (j = w.data("cmEditor"),
                            w.val(j.getValue()),
                            j.toTextArea()),
            ...
            a(document).on("dragenter", function(a) {
                ...
                f || 0 !== c.length || (b.editor.addClass("dragover"),
                    d.width(b.editor.width()),
                    d.height(b.editor.height()),
        ...
        this.bindKeyMap = function(a, b) {
            ...
            e.on("keydown", function(a) {
                ...
                var h = b[f.join("+")];
                h ? (a.preventDefault(),
                    d[h](e, c.data("options"))) : i.isEdit(a.keyCode) && d.recordUndo(e)
            })
        }
            ,
            this.attach = function(a, b) {
                ...
                if (f.on("mousemove", E),
                    ...
                    b.onpaste && a.editable.on("paste", b.onpaste),
    ...
    a.fn.extend({
        summernote: function(b) {
            if (b = a.extend({}, a.summernote.options, b),
