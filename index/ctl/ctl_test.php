...
class ctl_test
{
    ...
    {
        //// 使用 WebSocket 通知客户端
    $client = new sys_socket();
    //$client->connect($_SERVER['HTTP_HOST'], 9527, '/');
    $client->connect("127.0.0.1", 8888, '/json?utma=jjj&userid=1&username=yangzetao');
    ...
    public function service()
    {
        ...
        do{
            ...
            if($accept_resource !== false){
                ...
                flush();
                if($string != false){
                    $return_client = 'server receive is : I am every happy to recive you message'.PHP_EOL;
