...
# Database: sephp
# Generation Time: 2019-11-07 13:47:39 +0000
# ************************************************************
...
INSERT INTO `se_admin_user` (`admin_id`, `group_id`, `username`, `password`, `sex`, `email`, `status`, `realname`, `nickname`, `mobile`, `remark`, `auth_secert`, `reg_ip`, `session_id`, `app_token`, `addtim`, `uptime`, `deltime`)
VALUES
	(1,1,'admin','$2y$10$tra3DMOjyKhDpQD1qe82Oe6b3n7StDIkprH8UXtscUdYo46DnAsim',1,'admin@admin.com',1,'钢盔',NULL,NULL,'so fuck beautiful','EEOQBNTJ7CDGCWPDVSVVQGZ37FK7RBU7',NULL,'vsm7fnvsvdtjkpf9ts1s3s352j',NULL,NULL,0,0),
	(6,2,'gangkui003','$2y$10$rsRw/PKLQPfhpR.XwrD6m.ocMygl6gd4BEtuNAPJbokykX5e.AMG.',1,'asdfasd@123.com',1,'里相遇',NULL,NULL,'','DZWBRUUNUUJDAXXR44MVYMCUPOEMQIPS',NULL,'0',NULL,NULL,0,0),
	(11,5,'gangkui001','$2y$10$pLKmTwiz./w.8hPja3qQjuBdIwvskB3gPEY/ljVCdau6P/hElYELq',NULL,'001@adm.com',1,'钢盔01',NULL,NULL,'gangkui001','HOELO43EFXMWYYWKWCSZ3QEMWRPQLR33',NULL,'myprefix-brcmrvlo54bapnm4hm8mqjact6',NULL,NULL,0,0);
