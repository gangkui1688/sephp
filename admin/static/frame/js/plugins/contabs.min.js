    ...
    function n() {
        ...
        if ($(".J_menuTab").each(function () {return  $(this).data("id") == t ? ($(this).hasClass("active") || ( $(".J_mainContent .J_iframe").each(function () {
                return $(this).data("id") == t ? ($(this).show().siblings(".J_iframe").hide(), !1) : void 0 })), n = !1, !1)  : void 0 }), n) {
    ...
    function changeLeftMenu(id) {
        ...
        var str_html = '';
        for (i in left_menu[id]){
            str_html += '<li class="left-menu-li">';
            str_html += '<a class="J_menuItem" href="' + left_menu[id][i]['href']+ '" data-index="' + left_menu[id][i]['data-id'] + '"><i class="' +
                left_menu[id][i]['icon']+ '"></i> <span class="nav-label">' + left_menu[id][i]['title'];
            if(left_menu[id][i]['menu'] != undefined){
                str_html += '</span><span class="fa arrow"></span>';
            }
            str_html += '</a>';
            if(left_menu[id][i]['menu'] != undefined){
                str_html += '<ul class="nav nav-second-level collapse"> ';
                var childMenu = left_menu[id][i]['menu'];
                for (a in childMenu) {
                   str_html += '<li><a class="J_menuItem" href="' +childMenu[a]['href']+ '" data-index="' +childMenu[a]['data-id']+ '">' +
                       childMenu[a]['title']+ '</a></li>';
                }
            ...
            str_html += '</li>';
            console.log(left_menu[id][i]['menu']);
        }
        leftObj.find('li.left-menu-li').remove();
    ...
    $(function () {
        ...
        $('ul.top-navigation li').click(function () {
            ...
            $('ul.top-navigation li').removeAttr('class');
            $(this).attr('class','active');
            changeLeftMenu(id);
        });

        //初始化菜单
        changeLeftMenu(firstMenuId);
    });
