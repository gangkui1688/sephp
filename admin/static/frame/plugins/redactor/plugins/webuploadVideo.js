    ...
    $R.add('plugin', 'webuploadVideo', {
        ...
        initUploader: function () {
            ...
            uploader.on('error', function (code) {
                if (code == "Q_EXCEED_NUM_LIMIT") {
                    ...
                    parent.layer.msg("上传文件类型错误，请重新选择");
                }
            });
        ...
        _insert: function (e) {
            ...
            if(e && Object.keys(e).length > 0) {
                ...
                this.insertion.insertHtml($R.dom('<video controls="controls" src="'+data+'">'))
            } else {
                ...
                if(rel == 0) {
                    if(/^((http|ftp|https):\/\/)*[\w\-_]+(\.[\w\-_]+)+([\w\-\.,@?^=%&:/~\+#]*[\w\-\@?^=%&/~\+#])?/.test(data)) {
                        ...
                        this.insertion.insertHtml($R.dom('<p>'+data+'<p>'));
                    }
                } else if(rel == 1){
                    this.insertion.insertHtml($R.dom(this._html))
                }
            }
        },
