                            ...
                            <div class="box box-warning direct-chat direct-chat-warning">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="direct-chat-contacts">
                                        <ul class="contacts-list">
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="static/img/user1-128x128.jpg" alt="User Image">
                                ...
                                <span class="contacts-list-name">
                                  ...
                                  <small class="contacts-list-date pull-right">2/28/2015</small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="static/img/user7-128x128.jpg" alt="User Image">
                                ...
                                <span class="contacts-list-name">
                                  ...
                                  <small class="contacts-list-date pull-right">2/23/2015</small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="static/img/user3-128x128.jpg" alt="User Image">
                                ...
                                <span class="contacts-list-name">
                                  ...
                                  <small class="contacts-list-date pull-right">2/20/2015</small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="static/img/user5-128x128.jpg" alt="User Image">
                                ...
                                <span class="contacts-list-name">
                                  ...
                                  <small class="contacts-list-date pull-right">2/10/2015</small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="static/img/user6-128x128.jpg" alt="User Image">
                                ...
                                <span class="contacts-list-name">
                                  ...
                                  <small class="contacts-list-date pull-right">1/27/2015</small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="static/img/user8-128x128.jpg" alt="User Image">
...
<!-- Sparkline -->
<script src="static/plugins/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap  -->
